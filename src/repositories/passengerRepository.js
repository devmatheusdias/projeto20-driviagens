...
async function createPassenger(firstName, lastName) {
    ...
    const result = await db.query(`SELECT * FROM passengers ORDER BY id DESC LIMIT 1`);
...
export const passengerRepository = { createPassenger, findPassengerById, findTravels }
